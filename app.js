...
var currentFinger = "lindexfinger";
var samplecount = 1;
...
window.onload = function () {
    ...
    setSampleStatus("lfingersample1");
};
...
function clearSampleStatus () {
    document.getElementById("lfingersample1").style.backgroundColor = ""
}

function setSampleStatus (id) {
...
function setFingerCapturedStatus (id) {
    document.getElementById("id").style.borderColor = "yellogreen"
}
